...
def prepare_dataset(point_gen, n_p, dirname, n_batches=None, val_split=0.1, ltails=0, rtails=0, normalize_to_vol_j=True,average_selected_t = False, shuffle_points = True, batch_size = None):
    ...
    if not use_quadratic_method:
        ...
        if do_multiprocessing:
            ...
            n_batches = (n_p//100000) if n_p//10000 > 0 else 1
    ...
    print("verifying dtype of all points:",X_train.dtype,X_val.dtype,train_pullbacks.dtype, all_omega.dtype, all_weights.dtype)
