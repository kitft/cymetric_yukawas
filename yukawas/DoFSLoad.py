...
#free_coefficient=[3,-5,-2,-19,4,19,8,-13,1,7,-11,8,-7,12,-5,19,5,-4,16,-18,18]
arg= sys.argv[1]
...
if __name__ ==  '__main__':
    ...
    phimodel1,training_history=load_nn_phimodel(free_coefficient,depthPhi,widthPhi,nEpochsPhi,[64,50000],set_weights_to_zero=True)
    ...
    betamodel_02m20,training_historyBeta_02m20=load_nn_HYM(free_coefficient,linebundleforHYM_02m20,depthBeta,widthBeta,nEpochsBeta,[64,50000],set_weights_to_zero=True)
    gc.collect()
    tf.keras.backend.clear_session()
    ...
    betamodel_110m2,training_historyBeta_110m2=load_nn_HYM(free_coefficient,linebundleforHYM_110m2,depthBeta,widthBeta,nEpochsBeta,[64,50000],set_weights_to_zero=True)
    gc.collect()
    tf.keras.backend.clear_session()
    ...
    betamodel_m1m322,training_historyBeta_m1m322=load_nn_HYM(free_coefficient,linebundleforHYM_m1m322,depthBeta,widthBeta,nEpochsBeta,[64,50000],set_weights_to_zero=True)
    ...
    HFmodel_vH,trainingHistoryHF_vH=load_nn_HF(free_coefficient,linebundleforHYM_02m20,betamodel_02m20,functionforbaseharmonicform_jbar_for_vH,depthSigma,widthSigma,nEpochsSigma,[64,50000],alpha=alphasigma1,set_weights_to_zero=True)
    gc.collect()
    tf.keras.backend.clear_session()
    ...
    HFmodel_vQ3,trainingHistoryHF_vQ3=load_nn_HF(free_coefficient,linebundleforHYM_110m2,betamodel_110m2,functionforbaseharmonicform_jbar_for_vQ3,depthSigma,widthSigma,nEpochsSigma,[64,50000],alpha=alphasigma1,set_weights_to_zero=True)
    gc.collect()
    tf.keras.backend.clear_session()
    ...
    HFmodel_vU3,trainingHistoryHF_vU3=load_nn_HF(free_coefficient,linebundleforHYM_110m2,betamodel_110m2,functionforbaseharmonicform_jbar_for_vU3,depthSigma,widthSigma,nEpochsSigma,[64,50000],alpha=alphasigma1,set_weights_to_zero=True)
    ...
    HFmodel_vQ1,trainingHistoryHF_vQ1=load_nn_HF(free_coefficient,linebundleforHYM_m1m322,betamodel_m1m322,vFS_Q1,depthSigma,widthSigma,nEpochsSigma,[64,50000],alpha=alphasigma2,set_weights_to_zero=True)
    gc.collect()
    tf.keras.backend.clear_session()
    ...
    HFmodel_vQ2,trainingHistoryHF_vQ2=load_nn_HF(free_coefficient,linebundleforHYM_m1m322,betamodel_m1m322,vFS_Q2,depthSigma,widthSigma,nEpochsSigma,[64,50000],alpha=alphasigma2,set_weights_to_zero=True)
    gc.collect()
    tf.keras.backend.clear_session()
    ...
    HFmodel_vU1,trainingHistoryHF_vU1=load_nn_HF(free_coefficient,linebundleforHYM_m1m322,betamodel_m1m322,vFS_U1,depthSigma,widthSigma,nEpochsSigma,[64,50000],alpha=alphasigma2,set_weights_to_zero=True)
    gc.collect()
    tf.keras.backend.clear_session()
    ...
    HFmodel_vU2,trainingHistoryHF_vU2=load_nn_HF(free_coefficient,linebundleforHYM_m1m322,betamodel_m1m322,vFS_U2,depthSigma,widthSigma,nEpochsSigma,[64,50000],alpha=alphasigma2,set_weights_to_zero=True)
    gc.collect()
    tf.keras.backend.clear_session()
