...
nEpochsPhi = 10
nEpochsBeta = 5
nEpochsSigma = 5#changed below vH
...
if __name__ ==  '__main__':
    ...
    #mets=phimodel.fubini_study_pb(real_pts,ts=tf.cast(kmoduli,tf.complex64))
    ...
    generate_points_and_save_using_defaultsHF(free_coefficient,linebundleforHYM_02m20,functionforbaseharmonicform_jbar_for_vH,phi,betamodel_02m20,nPointsHF,force_generate=False,seed_set=seed_for_gen)
    if train_vH:
